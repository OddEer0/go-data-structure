...
func initTree2() rbtree.ITree[int, int] {
	tree := initTree()
...
func TestNodeBaseMethods(t *testing.T) {
	...
	t.Run("Should correct remove and balance element", func(t *testing.T) {
		...
		assert.Equal(t, tree.GetSize(), 11)
		assert.Equal(t, tree.GetRoot().Value(), 1050)
		assert.Equal(t, []int{1050, 1000, 950, 650, 600, 700, 960, 1030, 1150, 1100, 1220}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsRed(), true)
		...
		assert.Equal(t, tree.GetSize(), 10)
		assert.Equal(t, tree.GetRoot().Value(), 1000)
		assert.Equal(t, []int{1000, 950, 650, 600, 700, 960, 1050, 1030, 1150, 1100}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Right().IsBlack(), true)
		...
		assert.Equal(t, tree.GetSize(), 12)
		assert.Equal(t, tree.GetRoot().Value(), 1050)
		assert.Equal(t, []int{1050, 1000, 650, 600, 950, 700, 1030, 1150, 1100, 1220, 1200, 1250}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsRed(), true)
		assert.Equal(t, tree.GetRoot().Left().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().Right().Left().IsRed(), true)
		assert.Equal(t, tree.GetRoot().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Right().Left().IsRed(), true)
		...
		assert.Equal(t, tree.GetSize(), 11)
		assert.Equal(t, tree.GetRoot().Value(), 1050)
		assert.Equal(t, []int{1050, 1000, 700, 650, 950, 1030, 1150, 1100, 1220, 1200, 1250}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsRed(), true)
		assert.Equal(t, tree.GetRoot().Left().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().Right().IsBlack(), true)
		...
		assert.Equal(t, tree.GetSize(), 10)
		assert.Equal(t, tree.GetRoot().Value(), 1050)
		assert.Equal(t, []int{1050, 700, 650, 1000, 950, 1150, 1100, 1220, 1200, 1250}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Right().Left().IsRed(), true)
		assert.Equal(t, tree.GetRoot().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().Right().Left().IsRed(), true)
		...
		assert.Equal(t, tree.GetSize(), 12)
		assert.Equal(t, tree.GetRoot().Value(), 1050)
		assert.Equal(t, []int{1050, 1000, 950, 650, 600, 700, 960, 1030, 1200, 1100, 1220, 1250}, tree.ToPreOrderNodeSlice())
		assert.Equal(t, tree.GetRoot().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Right().IsBlack(), true)
		assert.Equal(t, tree.GetRoot().Left().Left().IsRed(), true)
